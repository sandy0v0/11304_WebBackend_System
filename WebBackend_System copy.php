                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="navbar-nav me-auto mx-auto">
                        <li class="nav-item me-4">
                            <a class="nav-link " href="#page0" onclick="">✨ 最新消息</a>
                        </li>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0 dropdown">
                            ...
                            <ul class="dropdown-menu text-small shadow"
                                ...
                                <!-- 使用者尚未登入 -->
                                <li><a class="dropdown-item" href="login.php"><img src="./images/left01.png" alt="管理專區"
                                            width="30" height="30"> 管理專區</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="login.php"><i class="fa-solid fa-user"></i> 管理登入</a>
                                </li>
                                <li><a class="dropdown-item" href="login.php"><i class="fa-regular fa-user"></i>
                                        會員登入</a></li>
                                <?php } else { ?>
                                <!-- 使用者已登入 -->
                                ...
                                <li><a class="dropdown-item" href="?admin.php"><i class="fa-solid fa-user"></i> 返回管理</a>
                                </li>
                                <?php } ?>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="cols-1 cols-lg-2 align-items-stretch g-4 py-2">
                    <div class="col" style="text-shadow: 2px 2px 6px rgba(0, 0, 0, 0.7);">
                        <div class="card card-cover h-600 overflow-hidden text-bg-white rounded-2  img-hover"
                            style="min-height: 300px; background-image: url('./images/esg.gif'); background-size: cover; background-position: top;">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="200">
        <footer class="py-2">
            ...
            <div
                ...
                <p class="mt-4">&copy; 2024–2025 Sustaina Life, Inc. 保留所有權利
